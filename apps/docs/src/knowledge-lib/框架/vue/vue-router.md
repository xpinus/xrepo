...
- beforeRouteLeave
  ...
  - ```js
    ...
    import { onBeforeRouteLeave, onBeforeRouteUpdate } from 'apps/docs/src/knowledge-lib/框架/vue/vue-router'
...
// 其他组件
import { useRouter } from 'apps/docs/src/knowledge-lib/框架/vue/vue-router'
