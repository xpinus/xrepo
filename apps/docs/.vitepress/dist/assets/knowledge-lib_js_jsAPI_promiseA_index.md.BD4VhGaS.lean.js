import{t as i,ao as l,K as r,u as s,y as o,a0 as t,ac as a,q as c}from"./chunks/framework.Dt9YBBJv.js";const u=`// Promise的三种状态\r
...
(function () {\r
    ...
    async function async2() {\r
        ...
        return MyPromise.resolve().then(() => {\r
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span></code></pre></div><ol start="2"><li>实例方法</li></ol><ul><li><code>Promise.prototype.then()</code>: 为 promise 添加被兑现和被拒绝状态的回调函数，其以回调函数的返回值兑现 promise。若不处理已兑现或者已拒绝状态（例如，onFulfilled 或 onRejected 不是一个函数），则返回 promise 被敲定时的值。</li><li><code>Promise.prototype.catch()</code>: 为 promise 添加一个被拒绝状态的回调函数，并返回一个新的 promise，若回调函数被调用，则兑现其返回值，否则兑现原来的 promise 兑现的值。</li><li><code>Promise.prototype.finally()</code>: 为 promise 添加一个回调函数，并返回一个新的 promise。这个新的 promise 将在原 promise 被兑现时兑现。而传入的回调函数将在原 promise 被敲定（无论被兑现还是被拒绝）时被调用。</li></ul><ol start="3"><li>静态方法</li></ol><ul><li><code>Promise.all(iterable)</code>: 一个新的 promise 对象，等到所有的 promise 对象<strong>都成功</strong>或有<strong>任意一个失败</strong>。 <ul><li>接受一个promise组成的可迭代对象</li><li>结果： <ul><li>成功：iterable 里所有 promise 返回值的数组作为成功回调的返回值。顺序跟 iterable 的顺序保持一致。</li><li>失败：一旦有<strong>任意一个</strong> iterable 里面的 promise 对象失败则立即以该 promise 对象失败的理由来拒绝这个新的 promise。</li></ul></li></ul></li><li><code>Promise.allSettled(iterable)</code>: 当<strong>所有</strong>的 promises 都已经结束无论是完成状态或者是失败状态，它都会返回一个 promise，这个 promise 将会包含一个关于描述每个 promise 状态结果的对象数组。 <ul><li>结果：<code>[ {status: &#39;xxx&#39;, value: xxx}, ... ]</code></li></ul></li><li><code>Promise.any(iterable)</code>: 当其中的任意一个 promise 成功，就返回那个成功的 promise 的值。<strong>不关心是否失败，关心第一个成功的</strong>，谁成功都行</li><li><code>Promise.race(iterable)</code>: 等到任意一个 promise 的状态变为已敲定。关心<strong>第一个成功或者失败</strong>的结果。</li><li><code>Promise.reject(reason)</code>和<code>Promise.resolve(value)</code>: 返回一个状态已兑现的 Promise 对象，并将给定的信息传递给对应的处理函数</li></ul><h2 id="手写promise" tabindex="-1">手写promise <a class="header-anchor" href="#手写promise" aria-label="Permalink to &quot;手写promise&quot;">​</a></h2><p><a href="https://www.cnblogs.com/dennisj/p/12660388.html" target="_blank" rel="noreferrer">手写promise</a></p>`,12)),r(e,{code:s(u)},null,8,["code"]),n[1]||(n[1]=o("h2",{id:"async-和-await",tabindex:"-1"},[t("async 和 await "),o("a",{class:"header-anchor",href:"#async-和-await","aria-label":'Permalink to "async 和 await"'},"​")],-1)),n[2]||(n[2]=o("p",null,"async 是 es7 新增的关键字，用于定义异步函数。通过 async 定义的函数返回一个 Promise 对象",-1)),n[3]||(n[3]=o("p",null,[t("await 是等待 async 的异步执行，而且只能在 async 里面定义。sync 函数执行时，如果"),o("strong",null,"遇到 await 就会先暂停执行 ，等到触发的异步操作完成后"),t("，恢复 async 函数的执行并返回解析值。")],-1)),n[4]||(n[4]=o("p",null,"await 关键字仅在 async function 中有效。如果在 async function 函数体外使用 await ，你只会得到一个语法错误。",-1)),r(e,{name:"利用生成器和迭代器实现相同效果",code:s(p)},null,8,["code"]),n[5]||(n[5]=o("h2",{id:"面试题",tabindex:"-1"},[t("面试题 "),o("a",{class:"header-anchor",href:"#面试题","aria-label":'Permalink to "面试题"'},"​")],-1)),r(e,{code:s(d)},null,8,["code"]),r(e,{code:s(h)},null,8,["code"]),n[6]||(n[6]=l('<ol><li>同步代码执行</li></ol><blockquote><p>console.log(&quot;script start&quot;); 是同步代码，首先执行，输出 script start。</p><p>调用 async1()，进入 async1 函数。</p><p>在 async1 中，遇到 await async2()，先执行 async2 函数。</p><p>async2 中的 console.log(&quot;async2 end&quot;); 是同步代码，输出 async2 end。</p><p>async2 返回一个 Promise.resolve().then(...)，这是一个微任务，.then会被放入微任务队列。</p><p>async1 函数在 await 处暂停，等待 async2 的 Promise 完成。</p><p>继续执行同步代码，new Promise(...) 中的 console.log(&quot;Promise&quot;); 是同步代码，输出 Promise。</p><p>Promise 的 resolve() 被调用，其后的 .then(...) 是微任务，放入微任务队列。</p><p>console.log(&quot;script end&quot;); 是同步代码，输出 script end。</p></blockquote><ol start="2"><li>异步代码执行</li></ol><blockquote><p>同步代码执行完毕后，开始执行微任务队列中的任务。</p><p>微任务队列中有两个任务：</p><p>async2 返回的 Promise.resolve().then(() =&gt; { console.log(&quot;async2 end1&quot;); });，输出 async2 end1。</p><p>new Promise 的 .then(function () { console.log(&quot;promise1&quot;); })，输出 promise1。</p><p>当第一个 .then 执行完毕后，会触发第二个 .then(function () { console.log(&quot;promise2&quot;); })，输出 promise2。</p><p>微任务队列清空后，async1 函数中 await 的 Promise 完成，继续执行 console.log(&quot;async1 end&quot;);，输出 async1 end。</p></blockquote><ol start="3"><li>宏任务执行</li></ol><blockquote><p>宏任务队列中有一个 setTimeout，等待所有微任务执行完毕后执行。输出 setTimeout。</p></blockquote>',6)),r(e,{code:s(m)},null,8,["code"]),r(e,{code:s(g)},null,8,["code"]),r(e,{code:s(y)},null,8,["code"]),r(e,{code:s(k)},null,8,["code"])])}}});export{j as __pageData,w as default};
