import{a as x}from"./chunks/theme.IAYrlGz0.js";import{p as f,q as d,t as c,y as p,K as t,I as e,a0 as s,a3 as g,ao as l,u as m,ac as k}from"./chunks/framework.Dt9YBBJv.js";const _={class:"container"},h={class:"tween-operations"},v=f({__name:"d1",setup(u){function i(){gsap.to(".box",{x:200})}function o(){gsap.from(".box",{x:-100,background:"pink"})}function r(){gsap.fromTo(".box",{x:-80,background:"blue"},{x:80,background:"green"})}function b(){gsap.set(".box",{x:-40,background:"blue"})}return(T,n)=>{const a=x;return d(),c("div",_,[p("div",h,[t(a,{onClick:i},{default:e(()=>n[0]||(n[0]=[s("to")])),_:1}),t(a,{onClick:o},{default:e(()=>n[1]||(n[1]=[s("from")])),_:1}),t(a,{onClick:r},{default:e(()=>n[2]||(n[2]=[s("fromTo")])),_:1}),t(a,{onClick:b},{default:e(()=>n[3]||(n[3]=[s("set")])),_:1})]),n[4]||(n[4]=p("div",{class:"box"},null,-1))])}}}),w=g(v,[["__scopeId","data-v-7bc30004"]]),S=`<script lang="ts" setup>
function to() {
