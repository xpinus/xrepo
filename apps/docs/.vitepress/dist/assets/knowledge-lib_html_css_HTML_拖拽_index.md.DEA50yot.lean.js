import{a3 as v,r as _,S as b,q as g,t as u,y as l,O as w,u as p,ao as P,K as c,I as h,a0 as y,ac as k}from"./chunks/framework.Dt9YBBJv.js";const A={class:"container"},I={__name:"demo1",setup(m){let i=_(),e=b({left:0,top:0}),a=0,n=0,t=0,o=0;function d(r){t=r.pageX,o=r.pageY,n=e.top,a=e.left,console.log("cat开始移动")}function x(r){let s=r.pageX,f=r.pageY;s===0&&f===0||(s-=t,f-=o,e.left=a+s,e.top=n+f)}function D(r){console.log("cat源对象拖动结束")}return(r,s)=>(g(),u("div",A,[s[0]||(s[0]=l("h3",null,"随着鼠标拖动而移动的小猫咪",-1)),l("div",{class:"target",ref_key:"cat",ref:i,style:w({left:p(e).left+"px",top:p(e).top+"px"}),draggable:"true",onDragstart:d,onDrag:x,onDragend:D},null,36)]))}},R=v(I,[["__scopeId","data-v-f234646e"]]),T=`<script setup>
