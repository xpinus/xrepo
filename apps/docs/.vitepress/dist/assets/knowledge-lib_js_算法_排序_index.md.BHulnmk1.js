...
<span class="line"><span>总时间 = c*N*(N−1)/2 = O(N^2).</span></span></code></pre></div>`,7)),e(s,{codePath:"knowledge-lib/js/算法/排序/bubbleSort.js"}),a[1]||(a[1]=n(`<h2 id="选择排序" tabindex="-1">选择排序 <a class="header-anchor" href="#选择排序" aria-label="Permalink to &quot;选择排序&quot;">​</a></h2><p>每一次循环都找出最小的元素，产生交换放在前面，两重循环O(n2)；举个栗子，5 8 5 2 9，第一遍之后，2会与5交换，那么原序列中两个5的顺序就被破坏了。所以<strong>不是稳定</strong>的排序算法。</p><p>不需要额外空间，空间复杂度O(1)。</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>method selectionSort(array A[], integer N)</span></span>
...
<span class="line"><span>    merge(a, low, mid, high) // 征服：合并子程</span></span></code></pre></div>`,4)),e(s,{codePath:"knowledge-lib/js/算法/排序/mergeSort.js"}),a[4]||(a[4]=n(`<h1 id="快速排序" tabindex="-1">快速排序 <a class="header-anchor" href="#快速排序" aria-label="Permalink to &quot;快速排序&quot;">​</a></h1><p>快速排序有两个方向</p><ul><li>左边的i下标一直往右走，当a[i] &lt;= a[center_index]，其中center_index是中枢元素的数组下标，一般取为数组第0个元素</li><li>而右边的j下标一直往左走，当a[j] &gt; a[center_index]。</li><li>如果i和j都走不动了，i &lt;= j, 交换a[i]和a[j],重复上面的过程，直到i&gt;j。</li><li>交换a[j]和a[center_index]，完成一趟快速排序。</li></ul><p>在中枢元素和a[j]交换的时候，很有可能把前面的元素的稳定性打乱，比如序列为 5 3 3 4 3 8 9 10 11， 现在中枢元素5和3(第5个元素，下标从1开始计)交换就会把元素3的稳定性打乱，所以快速排序是一个<strong>不稳定的排序算法</strong>，不稳定发生在中枢元素和a[j]交换的时刻。</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>int partition(array A, integer i, integer j)</span></span>
...
<span class="line"><span>    quickSort(A, m+1, high); // 然后排序右子数组</span></span></code></pre></div><h2 id="堆排" tabindex="-1">堆排 <a class="header-anchor" href="#堆排" aria-label="Permalink to &quot;堆排&quot;">​</a></h2>`,6))])}const k=p(o,[["render",r]]);export{u as __pageData,k as default};
